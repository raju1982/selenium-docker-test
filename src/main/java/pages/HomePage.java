...
public class HomePage {
    ...
    public void pageLoadTimes(){
        JavascriptExecutor jsExecutor = (JavascriptExecutor)driver;
        Long navigationStart = (Long) jsExecutor.executeScript("return window.performance.timing.navigationStart");
        Long responseStart = (Long) jsExecutor.executeScript("return window.performance.timing.responseStart");
        ...
        System.out.println("backendPerformance: " +  backendPerformance);
        System.out.println("frontendPerformance: " +  frontendPerformance);
    }
}
